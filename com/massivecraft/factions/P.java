...
import com.massivecraft.factions.cmd.CmdFWarpListener;
...
import com.massivecraft.factions.listeners.FactionsGUIListener;
import com.massivecraft.factions.listeners.FactionsPlayerListener;
import com.massivecraft.factions.listeners.FactionsRaidListener;
import com.massivecraft.factions.listeners.FactionsShieldListener;
import com.massivecraft.factions.listeners.FactionsUpgradeListener;
...
import com.massivecraft.factions.zcore.persist.json.JSONTerritoryAccess;
import com.massivecraft.factions.zcore.util.TextUtil;

import me.danelegend.core.classes.PvpClassManager;
import me.danelegend.core.classes.bard.EffectRestorer;
import me.danelegend.core.grace.GraceCommand;
import me.danelegend.core.grace.GraceListener;
import me.danelegend.core.grace.GraceTimer;
import me.danelegend.core.timer.TimerManager;
import me.danelegend.core.tntstorage.listeners.BlockListener;
import me.danelegend.core.tntstorage.listeners.InventoryListener;
...
public class P extends MPlugin {
	...
	private JSONTerritoryAccess saveAccess;
	...
	public void onEnable() {
		...
		saveAccess = new JSONTerritoryAccess();
		...
		getServer().getPluginManager().registerEvents(new FactionsShieldListener(), this);
		getServer().getPluginManager().registerEvents(new FactionsUpgradeListener(), this);
		getServer().getPluginManager().registerEvents(new FactionsGUIListener(), this);
		getServer().getPluginManager().registerEvents(new FactionsRaidListener(), this);
		getServer().getPluginManager().registerEvents(new CmdFWarpListener(), this);
	...
	public void startAutoLeaveTask(boolean restartIfRunning) {
		...
		if (Conf.autoLeaveRoutineRunsEveryXMinutes > 0.0) {
			...
			AutoLeaveTask = getServer().getScheduler().scheduleSyncRepeatingTask(this, new AutoLeaveTask(), ticks,
					ticks);
		}
	}
