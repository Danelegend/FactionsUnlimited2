...
public class CmdSetFWarp extends FCommand {
	...
	public void perform() {
		...
		int maxWarps = P.p.getConfig().getInt("max-warps", 9);
	...
	private boolean transact(FPlayer player) {
		return !P.p.getConfig().getBoolean("warp-cost.enabled", false) || player.isAdminBypassing()
				|| payForCommand(P.p.getConfig().getDouble("warp-cost.setwarp", 5),
						TL.COMMAND_SETFWARP_TOSET.toString(), TL.COMMAND_SETFWARP_FORSET.toString());
	}
