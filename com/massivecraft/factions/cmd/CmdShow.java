...
public class CmdShow extends FCommand {
    ...
    public CmdShow() {
        ...
        defaults.add("<a>Shield: <i>{shield}");
        defaults.add("<a>Balance: <i>{balance}");
        defaults.add("<a>Points: <i>{faction-points}");
        defaults.add("<a>Experience: <i>{faction-exp}");
        defaults.add("<a>Upgrades: <i>{faction-upgrades}/{faction-maxupgrades}");
