...
public class Conf {
	...
	public static double powerOfflineLossLimit = 0.0; // players will no longer lose power from being offline once their
														// power drops to this amount or less
	public static double powerFactionMax = 0.0; // if greater than 0, the cap on how much power a faction can have
												// (additional power from players beyond that will act as a "buffer" of
												// sorts)
	...
	// when faction membership hits this limit, players will no longer be able to
	// join using /f join; default is 0, no limit
	public static int factionMemberLimit = 15;

	// Set shield
	public static int territoryShieldFactor = 15;
	...
	public static String modChatFormat = ChatColor.YELLOW + "%s:" + ChatColor.WHITE + " %s";
	...
	public static int autoLeaveRoutineMaxMillisecondsPerTick = 5; // 1 server tick is roughly 50ms, so default max 10%
																	// of a tick
	...
	public static int chunkClaimDistance = 15;

	// if someone is doing a radius claim and the process fails to claim land this
	// many times in a row, it will exit
	...
	public static double econCostClaimWilderness = 0.0;
	public static double econCostClaimFromFactionBonus = 0.0;
	public static double econOverclaimRewardMultiplier = 0.0;
	public static double econClaimAdditionalMultiplier = 0.0;
	public static double econClaimRefundMultiplier = 0.0;
	public static double econClaimUnconnectedFee = 0.0;
	public static double econCostCreate = 0.0;
	public static double econCostOwner = 0.0;
	public static double econCostSethome = 0.0;
	...
	// Enable the %money% macro. Only do this if you know your economy manager is
	// thread-safe.
	...
	public static DynmapStyle dynmapDefaultStyle = new DynmapStyle().setStrokeColor(DYNMAP_STYLE_LINE_COLOR)
			.setLineOpacity(DYNMAP_STYLE_LINE_OPACITY).setLineWeight(DYNMAP_STYLE_LINE_WEIGHT)
	...
	// dynmapDefaultStyle.
	// Specify Faction either by name or UUID.
	public static Map<String, DynmapStyle> dynmapFactionStyles = ImmutableMap.of("SafeZone",
			new DynmapStyle().setStrokeColor("#FF00FF").setFillColor("#FF00FF").setBoost(false), "WarZone",
			new DynmapStyle().setStrokeColor("#FF0000").setFillColor("#FF0000").setBoost(false));

	// Faction banks, to pay for land claiming and other costs instead of
	// individuals paying for them
	public static boolean bankEnabled = true;
	public static boolean bankMembersCanWithdraw = false; // Have to be at least moderator to withdraw or pay money to
															// another faction
	public static boolean bankFactionPaysCosts = true; // The faction pays for faction command costs, such as sethome
	public static boolean bankFactionPaysLandCosts = true; // The faction pays for land claiming costs.

	// mainly for other plugins/mods that use a fake player to take actions, which
	// shouldn't be subject to our protections
	...
	public static transient int mapHeight = 19;
	public static transient int mapWidth = 52;
	public static transient char[] mapKeyChrs = "\\/#$%=&^ABCDEFGHJKLMNOPQRSTUVWXYZ1234567890abcdeghjmnopqrsuvwxyz?"
			.toCharArray();
	...
	static {
		...
		worldsIgnorePvP.add("lms");
		worldsNoPowerLoss.add("lms");
	}
