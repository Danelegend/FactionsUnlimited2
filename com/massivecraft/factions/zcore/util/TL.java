...
public enum TL {
     ...
     */
    COMMAND_FMISSION_DESCRIPTION("Allows you to view and start faction missions"),
    ...
    COMMAND_ACCESS_DESCRIPTION("Access command"),
    COMMAND_ACCESSFACTION_DESCRIPTION("Access a faction to your claim"),
    COMMAND_ACCESSPLAYER_DESCRIPTION("Access a player to your claim"),
    COMMAND_ACCESSVIEW_DESCRIPTION("View your access list"),
    ...
    COMMAND_BAN_DESCRIPTION("Ban a player from faction"),
    COMMAND_UNBAN_DESCRIPTION("Unban a player from faction"),
    COMMAND_BANLIST_DESCRIPTION("List all faction bans"),

    COMMAND_CHAT_DISABLED("<b>The built in chat channels are disabled on this server."),
    COMMAND_CHAT_INVALIDMODE("<b>Unrecognised chat mode. <i>Please enter either 'a','f', 't', 'm' or 'p'"),
    ...
    COMMAND_CORE_DESCRIPTION("Show the location of your faction core"),
    
    COMMAND_CRYSTAL_DESCRIPTION("Gives faction core item"),
    
    COMMAND_SHIELD_DESCRIPTION("Shows time remaining on faction shield"),
    
    COMMAND_STEALTH_DESCRIPTION("Activates stealth mode"),
    
    COMMAND_RULES_DESCRIPTION("Show faction rules"),
    COMMAND_RULESADD_DESCRIPTION("Add a faction rule"),
    COMMAND_RULESREMOVE_DESCRIPTION("Remove a faction rule"),
    COMMAND_RULESCLEAR_DESCRIPTION("Clear faction rules"),
    ...
    COMMAND_CLAIMCHUNK_INVALIDRADIUS("<b>If you specify a distance, it must be at least 1."),
    COMMAND_CLAIMCHUNK_DENIED("<b>You do not have permission to claim chunks."),
    COMMAND_CLAIMCHUNK_DESCRIPTION("Claim land at a coordinate."),
    COMMAND_CLAIMCHUNK_ABOVEMAX("<b>The maximum distance for claiming chunks is <b>%s<b>."),
    COMMAND_CLAIMCHUNK_NOTVALID("<b> is not correct usage of the command."),
    
    COMMAND_UNCLAIMCHUNK_INVALIDRADIUS("<b>If you specify a distance, it must be at least 1."),
    COMMAND_UNCLAIMCHUNK_DENIED("<b>You do not have permission to unclaim chunks."),
    COMMAND_UNCLAIMCHUNK_DESCRIPTION("Unclaim land at a coordinate."),
    COMMAND_UNCLAIMCHUNK_ABOVEMAX("<b>The maximum distance for unclaiming chunks is <b>%s<b>."),
    COMMAND_UNCLAIMCHUNK_NOTVALID("<b> is not correct usage of the command."),
    ...
    COMMAND_SETPOINTS_DESCRIPTION("Sets a faction's points"),
    COMMAND_SETTOKENS_DESCRIPTION("Sets a faction's tokens"),
    ...
    COMMAND_PERM_DESCRIPTION("Toggle faction permissions"),
    ...
    COMMAND_POINTS_DESCRIPTION("Shows amount of points a faction has"),
    
    COMMAND_TNT_DESCRIPTION("Shows amount of tnt a faction has"),
    
    COMMAND_TNTCHEST_DESCRIPTION("Gives a player a TNT chest"),
    
    COMMAND_TOKENS_DESCRIPTION("Shows amount of tokens a faction has"),
    ...
    COMMAND_STATS_DESCRIPTION("See a player's stats"),

    COMMAND_VAULT_DESCRIPTION("/f vault <number> to open one of your faction's vaults."),
    COMMAND_VAULT_TOOHIGH("&cYou do not have access to that faction vault."),
    ...
    COMMAND_TOGGLEMODCHAT_DESCRIPTION("Toggles whether or not you will see mod chat"),
    COMMAND_TOGGLEMODCHAT_IGNORE("Mod chat is now ignored"),
    COMMAND_TOGGLEMODCHAT_UNIGNORE("Mod chat is no longer ignored"),

    COMMAND_TOGGLESB_DISABLED("You can't toggle scoreboards while they are disabled."),

    COMMAND_TOP_DESCRIPTION("Sort Factions by points."),
    COMMAND_TOP_TOP("Top Factions. Page %d/%d"),
    COMMAND_TOP_LINE("%d. &6%s: &c%s"), // Rank. Faction: Value
    
    COMMAND_WEALTH_DESCRIPTION("Sort Factions by wealth."),
    COMMAND_CALCWEALTH_DESCRIPTION("Give factions points for wealth."),
